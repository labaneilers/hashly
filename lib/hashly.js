...
var createManifestEntryCss = function(fullPath, basePath, targetDir, data) {
    var processImagePath = function(virtualPath) {
        ...
        var imagePhysicalPath = virtualPath[0] != "/" ?
        ...
        // BUG: This is not preserving relative image paths in CSS
...
var processEntry = function(fullPath, baseDir, targetDir, data) {
    ...
    var createManifestEntryMethod = ext == ".css" ? createManifestEntryCss : createManifestEntry;
